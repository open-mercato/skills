...
| [`om-auto-create-pr-loop`](../skills/om-auto-create-pr-loop.md) | Implement a large spec | `/om-auto-create-pr-loop "Implement the multi-tenant billing spec"` | a resumable, step-tracked PR (continue with [`om-auto-continue-pr-loop`](../skills/om-auto-continue-pr-loop.md)) |
...
- Choose the loop variant ([`om-auto-create-pr-loop`](../skills/om-auto-create-pr-loop.md)) for long, many-step specs that need checkpoints and resumability; use the plain [`om-auto-create-pr`](../skills/om-auto-create-pr.md) for small fixes.
