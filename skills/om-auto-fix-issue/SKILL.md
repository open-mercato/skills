...
- File before fixing: brief mode turns a problem description into a tracker issue via `om-prepare-issue` (never composed inline) before any triage or claim; a numeric id that does not resolve stops the run.
